...
import software.jevera.demo.openid.blog.domain.Post;
import software.jevera.demo.openid.blog.repository.PostRepository;
...
/**
 * REST controller for managing {@link software.jevera.demo.openid.blog.domain.Post}.
 */
@RestController
@RequestMapping("/api")
@Transactional
