...
import software.jevera.demo.openid.blog.domain.Tag;
import software.jevera.demo.openid.blog.repository.TagRepository;
...
/**
 * REST controller for managing {@link software.jevera.demo.openid.blog.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
@Transactional
