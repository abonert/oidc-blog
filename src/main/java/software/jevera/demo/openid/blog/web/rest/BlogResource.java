...
import software.jevera.demo.openid.blog.domain.Blog;
import software.jevera.demo.openid.blog.repository.BlogRepository;
import software.jevera.demo.openid.blog.repository.UserRepository;
import software.jevera.demo.openid.blog.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link software.jevera.demo.openid.blog.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
